...
namespace Looper.Api.Migrations
{
    ...
    [Migration("20260908221116_AddUserActionResolution")]
    partial class AddUserActionResolution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Looper.Api.Domain.AgentPullRequest", b =>
                {
                    ...
                    b.Property<string>("SatisfiesAcs")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Looper.Api.Domain.LoopAgent", b =>
                {
                    ...
                    b.Property<string>("TriggerTopics")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Looper.Api.Domain.LooperEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Looper.Api.Domain.EventDelivery", b =>
                {
                    ...
                    b.HasOne("Looper.Api.Domain.LooperEvent", "Event")
                        .WithMany()
